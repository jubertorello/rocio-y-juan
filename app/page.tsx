...
export default function Home() {
  ...
  return (
    <main className={`min-h-screen relative selection:bg-[#5a5a40]/20 select-none md:select-text ${!showMain ? 'h-screen overflow-hidden' : ''}`}>
      ...
      <motion.div
        ...
        className="relative text-[#5a5a40] font-serif"
      >
        {/* STICKY HEADER NAVIGATION */}
        <nav className="fixed top-0 inset-x-0 bg-[#5a5a40] text-[#fbf9f4] border-b border-white/10 z-40 transition-all duration-300 shadow-md">
          <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
            <a
              href="#inicio"
              onClick={(e) => handleNavClick(e, 'inicio')}
              className="text-2xl md:text-3xl font-light tracking-[0.2em] uppercase text-[#fbf9f4] hover:opacity-80 transition-opacity cursor-pointer"
              style={{ fontFamily: 'Georgia', fontWeight: 'normal' }}
            >
              M & N
            </a>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={togglePlay}
                className="p-2 text-[#fbf9f4]/90 hover:text-white hover:bg-white/10 rounded-full transition-all duration-200 flex items-center justify-center focus:outline-none relative"
                ...
                {isPlaying ? (
                  <>
                    <span className="absolute top-1 right-1 flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#afb5a6] opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-[#afb5a6]"></span>
                    </span>
                    <Volume2 size={18} className="animate-pulse text-[#afb5a6] brightness-125" />
                  </>
                ) : (
                  <>
                    <span className="absolute top-1 right-1 block h-2 w-2 rounded-full bg-stone-400/80"></span>
                    <VolumeX size={18} className="opacity-60 text-[#fbf9f4]" />
                  </>
                )}
              </button>
              ...
              <a
                ...
                className="hidden md:inline-block px-4 py-1.5 border border-white/30 text-[#fbf9f4] hover:bg-[#fbf9f4] hover:text-[#5a5a40] transition-all duration-300 rounded-full text-[10px] uppercase font-sans tracking-[0.2em]"
              >
              ...
              <button
                ...
                className="md:hidden flex items-center space-x-1 px-3 py-1.5 border border-white/35 text-[#fbf9f4] hover:bg-white/10 transition-all rounded-full text-[10px] uppercase font-sans tracking-[0.15em] cursor-pointer"
          ...
          <AnimatePresence>
            {showMobileMenu && (
              <motion.div
                ...
                className="md:hidden overflow-hidden bg-[#5a5a40] border-t border-white/10"
              >
                <div className="px-6 py-4 flex flex-col space-y-4 text-center text-xs uppercase tracking-[0.2em] font-sans text-[#e8e4da] font-medium">
                  ...
                  <div className="pt-2">
                    <a
                      href="#confirmacion"
                      onClick={(e) => handleNavClick(e, 'confirmacion')}
                      className="inline-block w-full py-2.5 bg-[#fbf9f4] text-[#5a5a40] hover:bg-[#efeae0] transition-colors rounded-full text-[10px] tracking-[0.2em] font-bold"
                    >
                      Confirma tu asistencia
                    </a>
                  </div>
        ...
        >
          ...
          >
            <motion.p
              ...
              className="font-serif text-[#7a7a60] text-lg md:text-xl italic leading-relaxed max-w-sm mx-auto mb-5 text-center px-10 md:px-0"
            >
            ...
            <motion.p
              ...
              className="font-serif text-[#7a7a60] text-lg md:text-xl italic leading-relaxed max-w-sm mx-auto mb-10 text-center px-10 md:px-0"
            >
            ...
            <motion.h2
              ...
              className="tracking-[0.25em] uppercase text-[24px] leading-[24px] text-[#5a5a40] mb-8 text-center no-underline"
              style={{ fontFamily: 'Georgia', fontWeight: 'normal' }}
            >
              ¡Nos casamos!
            </motion.h2>
            ...
            <motion.p
              ...
              className="font-serif text-[#7a7a60] text-lg md:text-xl lg:text-xl italic leading-relaxed max-w-sm mx-auto mb-10 text-center px-9 md:px-0"
            >
          ...
          >
            ...
            >
              <div className="flex flex-col items-center">
                <h1 className="font-serif tracking-[0.1em] text-[32px] leading-[32px] text-[#3a3a28] uppercase font-light">
                  María Eugenia
                </h1>
                <span className="font-serif tracking-[0.05em] text-[20px] text-[#3a3a28] uppercase mt-1 font-light">
                  Monje Valverde
                </span>
              </div>

              <div className="font-serif text-2xl md:text-3xl my-4 text-[#3a3a28] font-light">
                &
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="font-serif tracking-[0.05em] text-[20px] leading-[30px] text-[#3a3a28] uppercase mt-1 font-light">
                  Heras Muñiz
                </span>
              </div>
            </motion.div>
            ...
            <motion.p
              ...
              className="font-serif text-[#7a7a60] text-lg md:text-xl lg:text-xl italic leading-relaxed max-w-sm mx-auto mb-5 text-center px-8 md:px-0"
            >
            ...
            >
              <div className="flex items-center justify-center gap-3 sm:gap-6 md:gap-8">
                {/* Month with borders */}
                <div className="border-y border-[#3a3a28]/40 py-2 text-center w-[110px] sm:w-[150px] flex-shrink-0">
                  <span
                    className="tracking-[0.2em] uppercase text-[#3a3a28] font-light block"
                    style={{ fontFamily: 'Georgia', fontSize: '14px', lineHeight: '14px', textAlign: 'center' }}
                  >
                    Septiembre
                  </span>
                </div>
                ...
                {/* Big Day */}
                <div className="text-5xl sm:text-6xl md:text-7xl font-serif font-light text-[#3a3a28] leading-none px-1 flex-shrink-0">
                  12
                </div>
                ...
                <div className="border-y border-[#3a3a28]/40 py-2 text-center w-[110px] sm:w-[150px] flex-shrink-0">
                  <span
                    className="tracking-[0.2em] text-[#3a3a28] font-light block"
                    style={{ fontFamily: 'Georgia', fontSize: '18px', lineHeight: '18px', textAlign: 'center' }}
                  >
                    2026
                  </span>
                </div>
              ...
              <div className="mt-6 text-center">
                <span
                  className="font-serif tracking-[0.25em] text-[#3a3a28] uppercase font-light"
        ...
        >
          ...
          >
            ...
            >
              <span className="font-sans text-[10px] uppercase tracking-[0.3em] text-[#7a7a60] mb-2 block">Ubicaciones</span>
              <h2 className="font-serif text-3xl md:text-4xl text-[#5a5a40] font-light italic">
                Dónde y Cuándo
              </h2>
              <div className="h-px w-10 bg-[#5a5a40]/20 mx-auto mt-4" />
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-stretch">
              ...
              >
                <div>
                  <div className="mb-6 text-center">
                    <span className="font-sans text-[10px] uppercase tracking-[0.3em] text-[#7a7a60] font-medium">La Ceremonia</span>
                  </div>

                  <h3
                    className="text-2xl text-[#5a5a40] mb-4 font-normal tracking-wide text-center"
                    style={{ fontFamily: 'Georgia' }}
                  >
                    Parroquia Corpus Christi
                  </h3>

                  <p className="font-serif text-[#7a7a60] text-sm italic mb-6 leading-relaxed text-center">
                  ...
                  <div className="flex items-center justify-center space-x-1.5 mb-8 text-[#7a7a60] text-xs">
                    <Clock size={13} className="opacity-85" />
                    <span style={{ fontFamily: 'Georgia' }}>17:00 H</span>
                  </div>
                </div>
                ...
                <div className="flex justify-center">
                  <a
                    ...
                    className="inline-flex items-center justify-center space-x-2 w-[220px] py-3 bg-[#5a5a40] hover:bg-[#5a5a40]/90 text-white rounded-full font-sans text-[10px] uppercase tracking-[0.2em] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02]"
                  >
              ...
              >
                <div>
                  <div className="mb-6 text-center">
                    <span className="font-sans text-[10px] uppercase tracking-[0.3em] text-[#7a7a60] font-medium">La Celebración</span>
                  </div>
                  ...
                  <div className="flex items-center justify-center space-x-1.5 mb-8 text-[#7a7a60] text-xs">
                    <Clock size={13} className="opacity-85" />
                    <span style={{ fontFamily: 'Georgia' }}>A partir de las 19:00 H</span>
                  </div>
                </div>
        ...
        >
          ...
          >
            ...
            >
              <h3 className="font-serif text-3xl md:text-4xl text-[#5a5a40] font-light italic">
            ...
            <div className="text-center w-full mb-16">
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-[#afb5a6] aspect-square rounded-full shadow-md border border-[#5a5a40]/10 flex flex-col items-center justify-center p-2 sm:p-3"
                >
                  <span className="text-3xl sm:text-4xl md:text-5xl font-serif text-white font-medium leading-none">{timeLeft.days}</span>
                  <span className="text-xs sm:text-sm md:text-base uppercase tracking-widest text-white/90 mt-1 sm:mt-1.5 font-light">Días</span>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-[#afb5a6] aspect-square rounded-full shadow-md border border-[#5a5a40]/10 flex flex-col items-center justify-center p-2 sm:p-3"
                >
                  <span className="text-3xl sm:text-4xl md:text-5xl font-serif text-white font-medium leading-none">{timeLeft.hours}</span>
                  <span className="text-xs sm:text-sm md:text-base uppercase tracking-widest text-white/90 mt-1 sm:mt-1.5 font-light">Horas</span>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-[#afb5a6] aspect-square rounded-full shadow-md border border-[#5a5a40]/10 flex flex-col items-center justify-center p-2 sm:p-3"
                >
                  <span className="text-3xl sm:text-4xl md:text-5xl font-serif text-white font-medium leading-none">{timeLeft.minutes}</span>
                  <span className="text-xs sm:text-sm md:text-base uppercase tracking-widest text-white/90 mt-1 sm:mt-1.5 font-light">Minutos</span>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-[#afb5a6] aspect-square rounded-full shadow-md border border-[#5a5a40]/10 flex flex-col items-center justify-center p-2 sm:p-3"
                >
                  <span className="text-3xl sm:text-4xl md:text-5xl font-serif text-white font-medium leading-none">{timeLeft.seconds}</span>
                  <span className="text-xs sm:text-sm md:text-base uppercase tracking-widest text-white/90 mt-1 sm:mt-1.5 font-light">Segundos</span>
                </motion.div>
              </motion.div>
            </div>
            ...
            >
              ...
              >
                <Image src={weddingPhotos[1]} alt="Mariu y Nacho" fill className="object-cover object-center" referrerPolicy="no-referrer" />
              </div>
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden">
                  <Image src={weddingPhotos[0]} alt="Mariu y Nacho" fill className="object-cover" referrerPolicy="no-referrer" />
                </div>
              </div>
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden">
                  <Image src={weddingPhotos[2]} alt="Mariu y Nacho" fill className="object-cover" referrerPolicy="no-referrer" />
                </div>
              </div>
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden">
                  <Image src={weddingPhotos[3]} alt="Mariu y Nacho" fill className="object-cover" referrerPolicy="no-referrer" />
                </div>
              </div>
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden">
                  <Image src={weddingPhotos[4]} alt="Mariu y Nacho" fill className="object-cover" referrerPolicy="no-referrer" />
                </div>
              </div>
              ...
              >
                <div className="relative w-full aspect-square overflow-hidden">
                  <Image src={weddingPhotos[5]} alt="Mariu y Nacho" fill className="object-cover" referrerPolicy="no-referrer" />
                </div>
              </div>
            </motion.div>
        ...
        <section
          id="itinerario"
          className="py-24 pt-16 pb-16 text-[#5a5a40] itinerario-section"
          style={{
        ...
        >
          ...
          >
            <motion.div
              ...
              className="text-center mb-16"
            >
              <span className="font-sans text-[10px] uppercase tracking-[0.3em] text-[#7a7a60] mb-2 block font-medium">Plan del Día</span>
              <h2 className="font-serif text-3xl md:text-4xl text-[#5a5a40] font-medium italic">
                Itinerario
              </h2>
              <p
                className="font-serif text-[#7a7a60] mt-2 italic"
                style={{ fontSize: '14px' }}
              >
            ...
            <div className="relative mt-12 pl-8 md:pl-0">
              {/* Center line */}
              <div className="absolute left-[60px] md:left-1/2 top-0 bottom-0 w-px bg-[#5a5a40]/20 transform md:-translate-x-1/2" />
              ...
              <div className="space-y-16">
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 md:pr-28 md:text-right mt-1 pl-[130px] md:pl-0">
                    <div className="inline-block px-3 py-1 bg-[#5a5a40]/5 border border-[#5a5a40]/15 rounded-full text-[#5a5a40] font-sans font-medium text-xs mb-2">
                      17:00 H
                    </div>
                    <h4 className="font-serif text-xl text-[#5a5a40] font-medium font-serif" style={{ fontFamily: 'Georgia' }}>La Ceremonia</h4>
                  </div>
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 md:pl-28 mt-1 pl-[130px]">
                    ...
                    <h4 className="font-serif text-xl text-[#5a5a40] font-medium font-serif" style={{ fontFamily: 'Georgia' }}>El Cóctel</h4>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 md:pr-28 md:text-right mt-1 pl-[130px] md:pl-0">
                    ...
                    <h4 className="font-serif text-xl text-[#5a5a40] font-medium font-serif" style={{ fontFamily: 'Georgia' }}>La Cena</h4>
                  </div>
                  <div className="w-full md:w-1/2 hidden md:block" />
                </motion.div>
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 md:pl-28 mt-1 pl-[130px]">
                    ...
                    <h4 className="font-serif text-xl text-[#5a5a40] font-medium font-serif" style={{ fontFamily: 'Georgia' }}>El Baile & Fiesta</h4>
                  </div>
                </motion.div>
        ...
        >
          ...
          >
            <motion.div
              ...
              className="bg-[#fbf9f4] border border-[#5a5a40]/10 rounded-sm p-10 md:p-14 shadow-sm relative overflow-hidden"
            >
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-48 h-1 bg-[#5a5a40]/10" />
              ...
              <h3 className="font-serif text-2xl md:text-3xl text-[#5a5a40] mb-4 font-light italic">
                Ayúdanos con la música
              </h3>

              <p className="text-[#7a7a60] text-[15px] italic leading-relaxed max-w-lg mx-auto mb-10">
              ...
              <button
                ...
                className="inline-flex items-center space-x-3 px-8 py-3 bg-[#5a5a40] hover:bg-[#5a5a40]/90 text-white font-sans text-[10px] uppercase tracking-[0.2em] rounded-full transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 active:scale-95 cursor-pointer"
              >
                <Music size={13} />
              ...
              {musicList.length > 0 && (
                <div className="mt-12 text-left max-w-md mx-auto">
                  <span className="text-[10px] uppercase tracking-wider text-[#7a7a60] block mb-4 border-b border-[#5a5a40]/10 pb-2 font-sans font-semibold">
                  ...
                  <div className="space-y-3">
                    {musicList.slice(0, 3).map((song, index) => (
                      <div
                        key={song.id}
                        className="flex items-center justify-between text-xs bg-[#efeae0]/30 p-2.5 rounded-md border border-[#5a5a40]/5"
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          <span className="text-[10px] font-bold text-[#5a5a40]/40 font-sans w-4 shrink-0">#{index + 1}</span>
                          <div className="min-w-0">
                            <span className="font-bold text-[#5a5a40] block truncate">{song.title}</span>
                            <span className="text-[#7a7a60]">{song.artist}</span>
                          </div>
                        </div>
                        <button
                          onClick={() => handleVoteSong(song.id)}
                          className="flex items-center space-x-1.5 px-2 py-1 hover:bg-[#5a5a40]/5 rounded font-sans text-[10px] uppercase text-[#7a7a60] border border-[#5a5a40]/10 transition-colors shrink-0 ml-2"
                        >
                          <Heart size={10} className="fill-[#5a5a40]/20 text-[#5a5a40]" />
                  ...
                  {musicList.length > 3 && (
                    <button
                      ...
                      className="mt-4 w-full py-2 text-[10px] uppercase tracking-wider font-sans font-semibold text-[#7a7a60] border border-[#5a5a40]/15 rounded-full hover:bg-[#5a5a40]/5 transition-colors cursor-pointer"
                    >
        ...
        <section id="viaje" className="py-24 pt-16 pb-16 bg-[#afb5a6] relative text-white">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            <motion.span
              ...
              className="font-sans text-[10px] uppercase tracking-[0.3em] text-white/80 mb-2 block font-medium"
            >
              Luna de Miel · Regalo
            </motion.span>
            <motion.h2
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center space-x-2 px-8 py-3.5 bg-white text-[#5a5a40] hover:bg-white/90 font-sans text-[11px] uppercase tracking-[0.22em] rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 cursor-pointer font-semibold"
              >
                <Gift size={13} />
        ...
        >
          ...
          >
            <div className="text-center mb-12">
              <div className="flex justify-center mb-6">
                <motion.div
                  ...
                  className="flex items-center justify-center w-16 h-16 rounded-full bg-[#5a5a40]/10"
                >
                  <Check size={32} className="text-[#5a5a40]" />
                </motion.div>
              </div>
              <motion.h2
                variants={{
                ...
                className="font-serif text-3xl md:text-4xl text-[#5a5a40] font-light italic"
              >
                Confirma tu asistencia
              </motion.h2>
              <motion.div
                ...
                className="h-px w-10 bg-[#5a5a40]/20 mx-auto mt-4 mb-6"
              />
              <motion.p
                variants={{
                  hidden: { opacity: 0, y: 20 },
                ...
                className="text-[13px] md:text-sm text-[#7a7a60] leading-relaxed max-w-md mx-auto"
                style={{ fontFamily: 'Georgia' }}
              >
                Para poder organizar con cariño y detalle este día, por favor, agradeceríamos que rellenarais este formulario antes del <strong className="text-[#5a5a40]">15 de agosto</strong>, gracias.
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              className="bg-[#fbf9f4] border border-[#5a5a40]/10 rounded-sm p-8 md:p-12 shadow-sm max-w-2xl mx-auto"
            >
              <RSVPForm
                key={formKey}
        ...
        >
          ...
          >
            <motion.div
              ...
              className="text-center mb-12"
            >
              <span className="font-sans text-[9px] uppercase tracking-[0.3em] font-bold text-[#5a5a40]/70">Información</span>
              <h3 className="font-serif text-2xl md:text-3xl text-[#5a5a40] mt-1 font-light italic">
                Datos de Interés
              </h3>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <motion.div
                ...
                className="bg-[#afb5a6] p-8 border border-white/10 rounded shadow-sm flex flex-col justify-between items-start text-left"
              >
                <div>
                  <h4
                    className="text-[17px] text-white font-medium mb-3"
                    style={{ fontFamily: 'Georgia' }}
                  >
        ...
        >
          ...
          >
            <motion.h3
              ...
              className="font-serif text-2xl text-[#5a5a40] mb-4 font-light italic"
            >
              ¿Dudas?
            </motion.h3>
            ...
            <motion.p
              ...
              className="text-sm text-[#7a7a60] leading-relaxed mb-10 max-w-md mx-auto"
              style={{ fontFamily: 'Georgia' }}
            >
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center space-x-3 w-full sm:w-auto px-6 py-3 bg-[#5a5a40] hover:bg-[#5a5a40]/90 text-white rounded-full font-sans text-[10px] uppercase tracking-[0.2em] transition-all duration-300 shadow-md hover:scale-105 active:scale-95"
              >
                <PhoneCall size={12} />
        ...
        <footer
          className="pt-28 pb-16 md:pt-32 md:pb-20 text-center relative overflow-hidden bg-[#afb5a6]"
          style={{
            backgroundImage: 'url("https://res.cloudinary.com/djqtkbyez/image/upload/v1779642177/Disen%CC%83o_sin_ti%CC%81tulo_3_t9bj44.png")',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
        ...
        >
          ...
          <div className="absolute inset-0 bg-[#5a5a40]/15 pointer-events-none z-0" />

          <div className="max-w-2xl mx-auto px-6 relative z-10">
            <span
              className="text-4xl md:text-5xl block mb-6 text-[#fbf9f4] drop-shadow-sm font-serif"
              style={{ fontFamily: 'Georgia', fontStyle: 'normal' }}
            >
              ¡Te esperamos!
            </span>
            <p className="font-serif text-[11px] md:text-xs uppercase tracking-[0.3em] text-[#fbf9f4] mb-2 font-medium drop-shadow-xs">
              Mariu y Nacho
            </p>
            <p className="font-sans font-medium text-[9px] md:text-[10px] text-[#fbf9f4]/85 tracking-widest uppercase drop-shadow-xs">
              12 de Septiembre de 2026 • Sevilla
            </p>
          </div>

          {/* Bottom thin bar */}
          <div className="absolute bottom-0 left-0 right-0 py-3 bg-[#5a5a40]/30 border-t border-[#fbf9f4]/10 z-10">
            <p className="font-sans text-[9px] md:text-[10px] text-[#fbf9f4]/80 tracking-widest">
              By{' '}
              <a
                href="https://wa.me/34660104026"
                target="_blank"
                rel="noopener noreferrer"
                className="underline underline-offset-2 hover:text-[#fbf9f4] transition-colors"
              >
                Jules
              </a>
          ...
          {showIbanModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-6 select-text">
              <motion.div
                ...
                className="absolute inset-0 bg-[#5a5a40]/45 backdrop-blur-xs"
              />
              ...
              <motion.div
                ...
                className="bg-[#fbf9f4] border border-[#5a5a40]/20 rounded-md shadow-2xl p-8 relative z-50 max-w-md w-full text-center"
              >
                <button
                  onClick={() => setShowIbanModal(false)}
                  className="absolute top-4 right-4 p-1.5 text-[#5a5a40]/60 hover:text-[#5a5a40] hover:bg-[#5a5a40]/5 rounded-full transition-colors cursor-pointer"
                >
                  <X size={18} />
                </button>

                <div className="flex justify-center mb-4 text-[#7a7a60]">
                  <Plane size={32} className="animate-bounce" />
                </div>

                <h3 className="font-serif text-2xl text-[#5a5a40] mb-3">Luna de Miel · Regalo</h3>

                <p className="text-xs text-[#7a7a60] leading-relaxed mb-6">
                ...
                <div className="bg-[#efeae0]/60 p-4 rounded-md border border-[#5a5a40]/10 mb-6 relative text-left">
                  {/* IBAN Section */}
                  <span className="block text-[8px] font-sans uppercase tracking-[0.2em] text-[#7a7a60] mb-2 font-bold">
                    Número de cuenta (IBAN):
                  </span>
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-sans text-xs md:text-sm text-[#5a5a40] select-all font-bold tracking-wider">
                      ES29 0182 4015 6002 0257 8448
                    </span>
                    <button
                      onClick={handleCopyIban}
                      className="p-2 bg-[#5a5a40]/5 hover:bg-[#5a5a40]/10 text-[#5a5a40] rounded transition-all active:scale-95 cursor-pointer"
                      title="Copiar IBAN"
                    >
                      {copied ? (
                  ...
                  {/* Info notice */}
                  <div className="flex items-start gap-1.5 mt-3 text-[9px] text-[#7a7a60] leading-snug">
                    <Info size={11} className="mt-0.5 flex-shrink-0 text-[#7a7a60]" />
                    <span>Con este código podrás recibir transferencias internacionales</span>
                  </div>

                  <span className="block text-[8px] text-[#7a7a60] mt-3 pt-2 border-t border-[#5a5a40]/5">
                    Titulares: María Eugenia M. V. e Ignacio H. M.
                  </span>
                </div>

                <p className="text-[10px] text-[#7a7a60] uppercase tracking-wider italic">
          ...
          {showMusicModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-6 select-text">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1, y: 0 }}
                exit={{ opacity: 0, scale: 0.95, y: 15 }}
                className="bg-[#fbf9f4] border border-[#5a5a40]/20 rounded-md shadow-2xl p-8 relative z-50 max-w-sm w-full"
              >
                <button
                  onClick={() => setShowMusicModal(false)}
                  className="absolute top-4 right-4 p-1.5 text-[#5a5a40]/60 hover:text-[#5a5a40] hover:bg-[#5a5a40]/5 rounded-full transition-colors cursor-pointer"
                ...
                <div className="text-center mb-6">
                  <Music size={26} className="text-[#7a7a60] mx-auto mb-2" />
                  <h3 className="font-serif text-xl text-[#5a5a40]">Sugerir Canción</h3>
                  <p className="text-xs text-[#7a7a60] mt-1">Queremos que la pista de baile no pare de sonar</p>
                </div>
                ...
                <AnimatePresence>
                  {showAddSongSuccess && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
                      className="bg-[#5a5a40]/10 border border-[#5a5a40]/25 rounded text-[#5a5a40] p-3 text-center mb-4 font-sans text-xs font-semibold flex items-center justify-center gap-1.5 overflow-hidden"
                    >
                      <Check size={14} />
                ...
                <form onSubmit={handleAddSong} className="space-y-4 text-xs">
                  <div>
                    <label className="block text-[9px] uppercase tracking-wider font-sans text-[#7a7a60] mb-1 font-semibold">
                    ...
                    <input
                      ...
                      className="w-full bg-[#efeae0]/30 border border-[#5a5a40]/20 rounded p-2 text-[#5a5a40] focus:outline-none focus:border-[#5a5a40] focus:bg-[#efeae0]/50 transition-colors font-sans"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-[#5a5a40] hover:bg-[#5a5a40]/90 text-white tracking-[0.2em] font-sans text-[10px] uppercase rounded-full transition-all duration-300 shadow hover:shadow-md cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
                  >
                    Añadir a la lista
                  </button>
                </form>

                <div className="mt-6 border-t border-[#5a5a40]/10 pt-4 max-h-40 overflow-y-auto pr-2 custom-scrollbar">
                  <span className="block text-[9px] uppercase font-bold tracking-wider text-[#7a7a60] mb-2 font-sans">
                    Sugiriendo actualmente ({musicList.length}):
                  </span>
                  <div className="space-y-2">
                    {musicList.map(song => (
                      <div key={song.id} className="flex justify-between items-center bg-[#efeae0]/30 p-2 rounded text-[11px] border border-[#5a5a40]/5">
                        <div className="truncate pr-4">
                          <span className="font-bold text-[#5a5a40]">{song.title}</span> - <span className="text-[#7a7a60]">{song.artist}</span>
                        </div>
                        <span className="text-[10px] font-sans font-bold bg-[#5a5a40]/5 px-2 py-0.5 rounded text-[#5a5a40]">
                          {song.votes} votos
                        </span>
                      </div>
                    ))}
          ...
          {showAllSongsModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-6 select-text">
              ...
              >
                ...
                <div className="text-center mb-6">
                  <Music size={26} className="text-[#7a7a60] mx-auto mb-2" />
                  <h3 className="font-serif text-xl text-[#5a5a40]">Playlist de los invitados</h3>
                  <p className="text-xs text-[#7a7a60] mt-1">{musicList.length} canciones sugeridas</p>
                </div>
                <div className="space-y-2 max-h-72 overflow-y-auto pr-1 custom-scrollbar">
                  {musicList.map((song, index) => (
                    <div key={song.id} className="flex items-center justify-between bg-[#efeae0]/30 p-2.5 rounded text-[11px] border border-[#5a5a40]/5">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <span className="text-[10px] font-bold text-[#5a5a40]/40 font-sans w-4 shrink-0">#{index + 1}</span>
                        <div className="min-w-0 truncate">
                          <span className="font-bold text-[#5a5a40]">{song.title}</span>
                          <span className="text-[#7a7a60]"> — {song.artist}</span>
                        </div>
                      </div>
                      <button
                        onClick={() => handleVoteSong(song.id)}
                        className="flex items-center space-x-1 px-2 py-1 hover:bg-[#5a5a40]/5 rounded font-sans text-[10px] text-[#7a7a60] border border-[#5a5a40]/10 transition-colors shrink-0 ml-2"
                      >
                        <Heart size={9} className="fill-[#5a5a40]/20 text-[#5a5a40]" />
                        <span>{song.votes}</span>
                      </button>
                    </div>
                  ))}
